...
Purpose:
This framework aims to use machine learning to accelerate the optimisation steps during the energy minimisation process used in non-linear response analysis, this research is currently ongoing so this code is not final and is still unfinished.
